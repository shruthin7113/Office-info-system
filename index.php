...
if (isset($_POST['login_user'])) {
  ...
  if (count($errors) == 0) {
    ...
    if (mysqli_num_rows($results) == 1) {
      ...
      header("location:home.php?info=add_section");
    }else {
...
<div class="container-fluid">
  <a class="navbar-brand" href="index.php"><h3 style="color: white" ><i class="fa fa-laptop" aria-hidden="true"></i> OFFICE STAFF INFO SYSTEM</h3></a>
 
</div>
</nav>
<hr>
 <h2 style="color:white; text-align:center;"> Admin Access Only </h2>
 <hr>
...
<form class="form " action="" method="post">
	  ...
	  <button type="submit" class="btn btn-outline-light mb-2" style="background-color: #f2ece6" name="login_user" ><font color="black"><b>LOGIN</b></font></button>
</form>
